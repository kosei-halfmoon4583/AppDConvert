...
public class CSVSiireTemp {
	...
	public CSVSiireTemp(String fName, String sName) {
		this.fileName = fName;
		this.saveName = sName;		
	}
	...
	public List<PaymentDetailsBeans> readers(){
		try {
			...
			CSVWriter writer = new CSVWriter(new FileWriter("/Users/kosei-halfmoon/CSVSiireTemp.csv"), ',', CSVWriter.DEFAULT_QUOTE_CHARACTER, "\r\n");
