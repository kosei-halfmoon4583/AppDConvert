...
public class CSVUriageTemp {
	...
	public CSVUriageTemp(String fName, String sName) {
		this.fileName = fName;
		this.saveName = sName;
	}
	...
	public List<PaymentDetailsBeans> readers(){
		...
		try {
			...
			//CSVWriter writer = new CSVWriter(new FileWriter(saveName), ',', CSVWriter.DEFAULT_QUOTE_CHARACTER, "\r\n");
			CSVWriter writer = new CSVWriter(new FileWriter("/Users/kosei-halfmoon/CSVUriageTemp.csv"), ',', CSVWriter.DEFAULT_QUOTE_CHARACTER, "\r\n");
			//CSVWriter writer = new CSVWriter(new FileWriter("/Users/kosei-halfmoon/output.csv")); /* フィールド区切り("")無しの場合のwriter定義 */
